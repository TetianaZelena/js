...
//   for(const product of products){
//   if (product[propName]) {
//       valuesName.push(product[propName])
...
// Используется синтаксис деструктуризации объекта highTemperatur
...
//        tomorrow: { high: tomorrowHigh, low: tomorrowLow }} = forecast;
...
// // Пиши код ниже этой строки
// function findMatches(arey, ...args) {
//   const matches = []; // Не изменяй эту строку
// for (const number of args ){
//   if(arey.includes(number)){
//     matches.push(number);
//   }
// }
//   // Пиши код выше этой строки
...
// пробный вариант через перебор не сработал
//   // for (let i=0; i< this.length; i+=1){
//    //const {name} = this.length[i];
//   // if (potionName===name){
//     // potions.splice(i,1); 
//     // }
//     //};
